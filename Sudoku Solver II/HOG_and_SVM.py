...
class SVM_classifier:
    ...
    def predict(self, X):
        ...
        scores_matrix = np.array(list(scores.values())).T
        return np.array([list(scores.keys())[i] for i in np.argmax(scores_matrix, axis=1)])
...
def main_train():
    ...
    if len(data) == 0:
        ...
        model_path = "svm_number_model_bin20_cell4.pkl"
